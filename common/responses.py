...
from blueapps.account.constants import ApiErrorCodeEnum, ApiErrorCodeEnumV2
...
class ApiV1FailJsonResponse(ApiV1BaseJsonResponse):
    def __init__(self, message, **kwargs):
        ...
        super().__init__(False, code, message, data=data)


class ApiV1OKJsonResponse(ApiV1BaseJsonResponse):
    def __init__(self, message, **kwargs):
        data = kwargs.get('data')
        super().__init__(True, ApiErrorCodeEnum.SUCCESS, message, data=data)
...
class ApiV2OKJsonResponse(ApiV2BaseJsonResponse):
    def __init__(self, message, **kwargs):
        data = kwargs.get('data')
        super().__init__(True, ApiErrorCodeEnumV2.SUCCESS, message, data=data)
